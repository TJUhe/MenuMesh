...
const std::unordered_set<std::string>& valueFlags() {
    static const std::unordered_set<std::string> flags = {
        ...
        "--smooth-curvature-threshold",
        "--smooth-curvature-edge-alignment",
        "--smooth-curvature-tangent-consistency",
        "--smooth-curvature-base-rings",
        "--smooth-curvature-scales",
        "--smooth-curvature-min-persistent-scales",
        "--smooth-curvature-robust-iterations",
