...
inline ::manumesh::simplification::SimplifyOptions
paperLineQuadricsOptions(double ratio) {
...
inline void expectBudgetedSimplification(const ::manumesh::test::SimplifiedMesh& result,
