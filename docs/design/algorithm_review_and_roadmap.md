...
本文按 ManuMesh 当前源码复核，而不是按早期设想描述。核对对象包括 `include/manumesh/algorithms/feature_detection/FeatureDetector.h`、`include/manumesh/algorithms/simplification/`、`src/feature_detection/`、`src/simplification/`、`apps/manumesh/` 和当前 80 个 CTest。算法本质和数学直觉见 [`algorithm_essence.md`](algorithm_essence.md)。
